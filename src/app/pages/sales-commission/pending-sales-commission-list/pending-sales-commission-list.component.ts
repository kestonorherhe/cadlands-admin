...
@Component({
  selector: "app-pending-sales-commission-list",
  templateUrl: "./pending-sales-commission-list.component.html",
  styleUrls: ["./pending-sales-commission-list.component.scss"],
})
export class PendingSalesCommissionListComponent implements OnInit {
  data = [];
