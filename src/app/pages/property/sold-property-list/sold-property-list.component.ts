...
@Component({
  selector: "app-sold-property-list",
  templateUrl: "./sold-property-list.component.html",
  styleUrls: ["./sold-property-list.component.scss"],
})

/**
 * Contacts-profile component
 */
export class SoldPropertyListComponent implements OnInit {
