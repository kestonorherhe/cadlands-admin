...
@Component({
  selector: "app-approved-application-request-list",
  templateUrl: "./approved-application-request-list.component.html",
  styleUrls: ["./approved-application-request-list.component.scss"],
})

/**
 * Contacts-profile component
 */
export class ApprovedApplicationRequestListComponent implements OnInit {
  ...
  getAllApplicationRequests() {
    ...
    this.applicationRequestService
      .getAllApplicationRequests({ status: "Approved" })
      .subscribe(
        (response: any) => {
