...
@Component({
  selector: "app-completed-application-request-list",
  templateUrl: "./completed-application-request-list.component.html",
  styleUrls: ["./completed-application-request-list.component.scss"],
})

/**
 * Contacts-profile component
 */
export class CompletedApplicationRequestListComponent implements OnInit {
  ...
  getAllApplicationRequests() {
    ...
    this.applicationRequestService
      .getAllApplicationRequests({ status: "Completed" })
      .subscribe(
        (response: any) => {
