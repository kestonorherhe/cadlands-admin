...
@Component({
  selector: "app-cancelled-application-request-list",
  templateUrl: "./cancelled-application-request-list.component.html",
  styleUrls: ["./cancelled-application-request-list.component.scss"],
})

/**
 * Contacts-profile component
 */
export class CancelledApplicationRequestListComponent implements OnInit {
