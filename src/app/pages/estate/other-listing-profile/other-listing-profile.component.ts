...
@Component({
  selector: "app-other-listing-profile",
  templateUrl: "./other-listing-profile.component.html",
  styleUrls: ["./other-listing-profile.component.scss"],
  providers: [AdvancedService, DecimalPipe],
})
export class OtherListingProfileComponent implements OnInit {
  isLoading = false;
  ...
  ngOnInit() {
    this.estates$ = this.propertyService.getAllOtherEstateListings({});
    ...
    this.getAllDirectSaleCommissions();
    this.getAllIndirectSaleCommissions();
  }
  ...
  getAllDirectSaleCommissions() {
    this.directSaleCommissions$ =
      this.propertyService.getAllDirectSaleCommissions({
        estateId: this.estateId,
      });
  }
  getAllIndirectSaleCommissions() {
    this.indirectSaleCommissions$ =
      this.propertyService.getAllIndirectSaleCommissions({
        estateId: this.estateId,
      });
  }
  ...
  getRecord() {
    this.propertyService
      .getAllOtherEstateListings({ estateId: this.estateId })
      .subscribe({
        next: async (response: any) => {
  ...
  onSubmitDirectSaleCommission() {
      ...
      this.propertyService.createDirectSaleCommission(data).subscribe(
        (response: any) => {
          this.isLoading = false;
          Swal.fire(
            "Process Successful!",
    ...
    onSubmitIndirectSaleCommission() {
      ...
      this.propertyService.createIndirectSaleCommission(data).subscribe(
        (response: any) => {
          this.isLoading = false;
          Swal.fire(
            "Process Successful!",
